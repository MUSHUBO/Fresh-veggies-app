...
const NavBar = () => {
	...
	return (
		<div className="">
			<div className='navbar rounded-lg w-11/12 mx-auto bg-gradient-to-tr from-green-50 to-green-100'>
				<div className="navbar-start">
					...
					<Link href={"/"} className='flex items-center justify-center ml-2 gap-2'>
						<Image src={"/assets/Logo.png"} width={40} height={30} alt="Fresh Veggies Logo" />
